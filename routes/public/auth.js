...
(function hideGatedEarly() {
  try {
    ...
    s.textContent = "[data-perm],[data-manage-hub],[data-role-only],.techNavTitle,.navSectionTitle{display:none !important} html.perms-ready [data-perm].perm-allowed, html.perms-ready [data-manage-hub].perm-allowed, html.perms-ready [data-role-only].perm-allowed, html.perms-ready .techNavTitle.perm-allowed{display:block !important} html.perms-ready .navItem.perm-allowed{display:flex !important} html.perms-ready .tabBtn.perm-allowed, html.perms-ready .btn.perm-allowed{display:inline-flex !important}";
  ...
  try {
    ...
    const setVisible = (el, allowed) => {
      ...
      if (allowed) {
        ...
        if (cs.display === "none") {
          if (el.classList.contains("navItem")) el.style.display = "block"; else if (el.classList.contains("btn") || el.classList.contains("tabBtn")) el.style.display = "inline-flex"; else if (el.tagName === "TR") el.style.display = "table-row"; else if (el.tagName === "TD" || el.tagName === "TH") el.style.display = "table-cell"; else el.style.display = "block";
        }
      } else {
